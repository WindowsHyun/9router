 ...
 * invisible until someone edits `open-sse/config/providerModels.js`. Meanwhile
 * the provider's own list has been fetched on every provider page load all
 * along — and thrown away for every provider except cursor and zed.
 *
